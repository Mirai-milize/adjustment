...
if __name__ == "__main__":
    ...
    try:
        ...
        if schedule:
            ...
            import_collection_data = input("수금 내역 Excel 파일을 입력하시겠습니까? (예/아니오): ").lower()
            if import_collection_data == '예':
                collection_file_path = input("수금 내역 Excel 파일 경로를 입력하세요 (예: C:/Users/user/Documents/collection.xlsx): ")
